...
Nakonec byla vybrána poslední možnost - jednoduchý značkovací jazyk, jímž se bude popisovat obsah snímku. Text se pak následně převede do kódu HTML. Více je popsáno v~kapitole \ref{chap:realizace} \nameref{chap:realizace} na str. \pageref{chap:realizace}.
